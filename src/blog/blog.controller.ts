...
import {
  CheckOptionalUploadedFile,
  CheckRequiredUploadedFile,
} from "src/common/decorator/upload-file.decorator";
...
export class BlogController {
  ...
  @ApiParam({ name: "id", type: "string" })
  async update(
    @CheckOptionalUploadedFile(MIME_TYPE.IMAGE) file: MulterFile,
    @Param("id") id: string,
